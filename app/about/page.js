...
const page = () => {
  return (
     <main className="flex min-h-screen flex-col items-center w-full p-24 sm:p-0 ">
      <div className='p-20 sm:p-0 sm:pt-20 sm:pb-20 text-center bg-[#FFF] sm:text-left'>
...
<div className='h-[794px] bg-[#0443E2] w-full sm:w-[390px] pl-[104px] pr-[98px] pt-[72px] mt-20 sm:pr-0 sm:h-[1248px] sm:mt-6 sm:pl-0 sm:pt-6'>
  <div className='flex flex-row mb-20 space-x-12 sm:flex-col sm:mb-0 sm:space-x-0 '>
<div className='w-[573px] pt-8 sm:pt-0 sm:w-[390px]'>
...
<div className='w-[573px] pt-8 sm:pt-0 sm:w-[390px]'>
  ...
  <p className='text-[#E1E1E1] text-[16px] sm:w-[350px] sm:ml-4 sm:mb-4'>At UVISE, we a shared vision to bridge the gap between technology and business. We set out on a mission to revolutionize the industry by delivering exceptional IT services that deliver real value. Our dedication to client success and relentless pursuit of excellence have earned us a reputation as a trusted technology solutions architect.</p>
    ...
    <div className='h-[1200px] bg-purple w-[1440px] mt-20 pt-12 sm:h-[2500px] sm:w-[390px]'>
...
<div className='flex  flex-row justify-around space-x-[-200px] sm:space-x-0 sm:flex-col sm:space-y-4 sm:items-center sm:justify-center '>
   ...
   <div className=' '>
   <div className='flex flex-row justify-around space-x-[-600px] sm:space-x-0 sm:flex-col sm:space-y-4 sm:items-center sm:justify-center mt-4 mb-4'>
   <div className='w-[395px] sm:w-[350px] bg-white h-[307px] flex flex-col justify-around items-center  rounded-[8px] shadow  '>
       <div className='w-[120px] h-[120px] rounded-full bg-[#D9D9D9] mt-10'>
         <Image 
            src={dat}
   ...
   <div className='flex flex-row justify-around space-x-[-600px] sm:space-x-0 sm:flex-col sm:space-y-4 sm:items-center sm:justify-center'>
   ...
   <div className='bg-white sm:w-full'>
        ...
        <div className='flex justify-between space-x-4 sm:space-x-0 pl-[105px] pr-[105px] sm:flex-col sm:pr-0 sm:pl-0'>
        ...
        <div className='flex justify-between pl-[105px] pr-[105px] mt-5 sm:flex-col sm:pl-0 sm:pr-0 '>
