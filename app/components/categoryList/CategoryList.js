...
const CategoryList = () => {
  return (
    <div className='sm:w-[390px]'>
      <h1 className='text-[32px] ml-[125px] pb-10 sm:ml-[10px]'>Popular Categories</h1>
      <div className='flex space-x-[50px] ml-[125px] sm:flex-col sm:space-x-0 sm:ml-[10px] '>
          <div className='sm:flex sm:flex-row sm:space-x-2 sm:mb-2 flex-row space-y-4'>
          ...
          <div className='sm:flex sm:flex-row sm:space-x-2 space-y-4'>
