  ...
  return (
    <main className="">
      <div className={nunito.className}>
        <div className=' bg-[#FFF] flex justify-between items-center  mx-auto lg:px-0 px-32 pt-32 pb-32 lg:max-w-[976px] sm:w-[390px] sm:m-4 sm:flex-col sm:px-[24px] '>
      ...
      <div className='w-[500px] h-[499px] lg:w-[400px] lg:h-[399px] sm:w-[320px] sm:h-[320px] ' ref={animationContainer}> 
        ...
        <div className= {nunito.className}>
          <div className=' max-w-[1440px] flex flex-col  items-center justify-center bg-purple  mt-1  pb-20 h-[597px] sm:mt-[2px] sm:h-[1800px] sm:sm:max-w-[480px] sm:justify-center sm:items-center  '>
      ...
      <div className='h-[674px] bg-blue max-w-[1440px] sm:mt-20 sm:flex sm:flex-col sm:max-w-[480px] sm: sm:h-[820px]  '>
        ...
        <div className='bg-white sm:w-[390px]'>
        ...
        <div className=' flex top-0 space-x-1 bg-purple w-[604px] h-[249px]  pt-[35px] sm:w-[480px] sm:h-[249px] sm:mb-4'>
          ...
          <h2 className='text-[#2A2A2A] text-[24px] font-[600] pl-3 sm:text-left sm:pl-1 sm:mb-4'>Expert Team</h2>
        ...
        <div className='flex w-[604px] h-[249px] bg-purple pt-[35px]  top-0 space-x-1  '>
        ...
        <div className='flex w-[604px] h-[249px] bg-purple pt-[35px] top-0 space-x-1  sm:mb-4'>
        ...
        <div className={nunito.className}>
        <div className='h-[595px] bg-purple max-w-[1440px] mt-20 pt-12 sm:h-[1200px] sm:max-w-[480px] '>
   ...
   <div className='max-w-[1440px] h-[478px] ml-[177px] mr-[177px] mb-10 sm:flex sm:flex-col sm:w-[480px] sm:justify-center sm:items-center sm:mt-[150px] sm:mr-0 sm:ml-[-60px] sm:h-[635px]'>
    ...
    <div className='flex space-x-20 sm:flex-col'>
      ...
      <div className='w-[381px] h-[185px]'>
        <h2 className='text-[32px] font-[600] sm:text-[24px]'>Blog post tittle heading</h2>
      <p className='text-[16px] mb-[40px] mt-[16px] font-[400] text-[#666] sm:text-[14px]'>Blog post description or little introduction on what the article is about
</p> 
